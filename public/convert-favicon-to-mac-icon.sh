...
convert -background none -density 300 lulm.svg -resize 512x512 android/android-launchericon-512-512.png

# Create iOS icon (no padding)
convert -background none -density 300 lulm.svg -resize 180x180 ios/180.png
