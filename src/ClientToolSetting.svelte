...
<h1 class="mb-4 text-xl font-semibold sm:mb-5">Client-side tool</h1>
	...
	<div class="mb-3 flex w-full flex-col gap-y-3">
		{#each toolDefinition.arguments as argument, i}
			<div class="flex w-full gap-x-3">
				<label class="flex w-full flex-col text-[8px] uppercase tracking-wide">
					...
					/></label
				>
				<label class="flex w-[180px] shrink-0 flex-col text-[8px] uppercase tracking-wide">
